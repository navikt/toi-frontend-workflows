...
GitHub Actions tillater dessverre ikke expressions i `uses:`-feltet, så denne sed-runden
er nødvendig — ellers vil `v2`-workflow'en kjøre `v1` av sine egne actions.
